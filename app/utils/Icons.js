...
export const logout = <i style={{color:'#EE3333'}} className="fa-solid fa-right-from-bracket"></i>;
...
export const edit = <i style={{color:'#E1DB1C '}} className="fa-solid fa-file-pen"></i>;
export const users = <i className="fa-solid fa-user-group"></i>;
export const todo = <i style={{color:'#E1DB1C '}} className="fa-solid fa-clipboard-list"></i>;
export const down = <i className="fa-solid fa-caret-down"></i>;
export const trash = <i style={{color:'#EE3333'}} className="fa-solid fa-trash"></i>;
